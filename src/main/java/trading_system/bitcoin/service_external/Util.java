...
public class Util {
    ...
    public static String base64Encode(byte[] bytes) {
		String bytesEncoded = HttpRequest.Base64.encode(String.valueOf(bytes));
		return bytesEncoded;
    }
    ...
    public static String hashToString(String data, byte[] key) {
		...
		try {
		    ...
		    result = HttpRequest.Base64.encode(String.valueOf(mac_data));
		} catch (Exception e) {
		    e.printStackTrace();
		}
		return result;
    ...
    public static String asHex(byte[] bytes) {
    	return new String(HttpRequest.Base64.encode(String.valueOf(bytes)));
    }
